...
* Email: [ml4allconf@gmail.com]
* In person: Any organizer, identified by STAFF badges or shirts for each day of ML4ALL.
...
All organizers, attendees, speakers, sponsors, and volunteers at ML4ALL are required to agree with the following Code of Conduct. Organizers will enforce this code throughout the event. We expect cooperation from all participants to ensure a safe environment for everybody.
...
If you feel uncomfortable, are being harassed, notice that someone else is being harassed, or have any other concerns, please contact a member of conference staff immediately. Conference Staff are identified by STAFF badges or shirts for each day of ML4ALL.

You can also send an email to [ml4allconf@gmail.com].

Immediate Response SMS number: [1 \(503\) 890-8036](tel:+15038908036)

### Enforcement

If a participant is asked to stop harassing or inappropriate behavior, they are expected to do so immediately. If a participant engages in harassing behavior, the conference organizers may take any action they deem appropriate; this may include warning the participant, immediate expulsion from the conference with no refund, and/or banning from any future ML4ALL conferences or associated events.

...
<html>
  <head>
    ...
    <meta name="description" content="ML4ALL - A machine learning conference for the rest of us. October 8-10, 2017, Portland, OR">
    ...
    <meta name="twitter:description" content="ML4ALL - A machine learning conference for the rest of us. October 8-10, 2017, Portland, OR">
      ...
      <div class="column is-10 is-offset-1">
        <div class="columns is-mobile">
          ...
          <div class="column is-7">
            ...
            <h2 class="logo">OCTOBER 8-10, 2017 - PDX</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="footer">
      <div class="container">
        <div class="content has-text-centered">
          <p>
            <strong>&copy; ML4ALL Conference</strong> 2017 - <a href="code-of-conduct.html">Code of Conduct</a>
          </p>
          <p>
